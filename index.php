<?php
        ...
        //ARRAY ASSOCIATIVO CHE CONTIENE TUTTE LE CHIAVI PER LE DOMANDE E LE RISPOSTE
        $faqs = [
            [
...
<body>
    ...
    <header>
        <div class="header-top">
            ...
            <div class="title">Privacy e termini</div>
        ...
        <div class="header-bottom">
            <ul>
                ...
                <li><a href="#">Termidi si servizio</a></li>
    ...
    <main>
        <div class="container">
            ...
            <!-- APRO UN CODICE PHP PER CICLARE TRAMITE IL CICLO FOR EACH IL MIO ARRAY ASSOCIATIVO -->

            <?php
                    foreach ($faqs as $faq ){
                        echo '<div class="faq">';
                        echo '<h2>'. $faq['domanda'] . '</h2>';
                        echo '<p>' . nl2br($faq['risposta']) . '</p>';
                        echo '</div>';                      
                    }
            ?>
